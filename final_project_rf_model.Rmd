...
start_df <- dummy_cols(start_df, select_columns = c("start_station_name","season_num", "year","is_holiday","day_of_week","month"), remove_selected_columns =TRUE)
drops = c("k_date","FeelsLikeC","humididty","visibilityKM","month","uvIndex","cloudcover","day")
...
```{r}
set.seed(123)
train_ind <- createDataPartition(start_df$count,p = 0.1, list = FALSE)
